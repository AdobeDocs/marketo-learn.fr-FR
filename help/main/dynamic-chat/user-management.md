...
description: Découvrez comment utiliser Adobe Admin Console pour gérer l’accès utilisateur de Dynamic Chat.
role: User
level: Beginner
jira: KT-9686
...
# Ajouter et gérer des utilisateurs de 

Gérez vos utilisateurs  via Adobe Admin Console.
